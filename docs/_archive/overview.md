> **⚠️ 文档迁移提示**：本文件为历史架构讨论记录。最新的项目架构、拓扑、不变量已按 OKF（Open Knowledge Format）整理至 `.knowledge/architecture/`。建议 Agent 优先阅读：
...
> 
> 最新数据：v0.20.1 / Schema v36 / 71 MCP tools / 12 workspace crates。
