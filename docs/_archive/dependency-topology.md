> **⚠️ 文档迁移提示**：本文件为历史拓扑规划。最新、已维护的 11-Tier 模块依赖拓扑已按 OKF 整理至 `.knowledge/architecture/dependency-topology.md`，关键数据已更新为 v0.20.1 / Schema v36 / 71 MCP tools / 12 workspace crates。本文件保留历史上下文，但其中的工具数量、schema 版本等数字可能已过时。
