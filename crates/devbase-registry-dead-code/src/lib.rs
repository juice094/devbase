...
mod tests {
    ...
    fn seed_data(conn: &rusqlite::Connection) {
        ...
        let symbols = [
            ("repo-a", "src/main.rs", "function", "main", 1, 5, Some("pub fn main()"), None::<&str>),
            ("repo-a", "src/lib.rs", "function", "helper", 10, 20, Some("fn helper()"), None::<&str>),
            ("repo-a", "src/lib.rs", "function", "unused_fn", 30, 40, Some("fn unused_fn()"), None::<&str>),
            ("repo-a", "src/lib.rs", "function", "pub_api", 50, 60, Some("pub fn pub_api()"), None::<&str>),
            ("repo-a", "src/tests.rs", "function", "test_something", 1, 10, Some("fn test_something()"), None::<&str>),
            ("repo-a", "src/utils.rs", "function", "test_helper", 1, 5, Some("fn test_helper()"), None::<&str>),
